  ...
  <h1>Add product</h1>
    <form action="add-product_handling.php" class="form" method="post">
      ...
      <div>
        ...
        <select type="text" id="imagefolder" name="imagefolder">
          <option value ="product-image/Nike/">Nike/</option>
          <option value ="product-image/Adidas/">Adidas/</option>
          <option value ="product-image/Puma/">Puma/</option>
          <option value ="product-image/Vans/">Vans/</option>
          <option value ="product-image/NB/">NB/</option>
          <option value ="product-image/Kids/">Kids/</option>
        </select><br><br>
      </div>
      <div>
