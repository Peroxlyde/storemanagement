...
$input = $_GET['myInput'];
$sql = "SELECT product.productName, product.price, product.image, product.quantity, location.Zone, product.locationID FROM product join location on product.locationID = location.locationID WHERE product.productName like '%$input%' or product.price like '%$input%'";
?>
        ...
        <div>
            ...
            <?php 
                ...
                if($result-> num_rows > 0){
                    echo '<h1 style="text-align: center; margin-top: 80px;"><a href="main.php">Home</a>/Search result: '.$input.'</h1>';
                    ...
                    while($row = $result -> fetch_assoc()){
                        ...
                        //echo '<a href="store_map.php"><p style="color: black;">Zone '.$row['Zone']. '</p><a>';
                        if ($row['quantity'] != 0){
                    ...
                    echo '<h1 style="text-align: center; margin-top: 80px;"><a href="main.php">'.$input.'</a>/Search result</h1>';
