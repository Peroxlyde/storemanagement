...
$sql = "SELECT product.productName, product.price, product.image, product.quantity, location.Zone, product.locationID FROM product join location on product.locationID = location.locationID Where product.supplierID IN (SELECT supplierID FROM supplier WHERE supplierName like '%New Balance%')";
?>
...
<body>
    ...
    <div class="centerpage">
        <div>
            <div>
                <h1 style="text-align: center; margin-top: 80px;"><a href="main.php">Home</a>/New Balance</h1>
            </div>
            <div>    
            <?php 
