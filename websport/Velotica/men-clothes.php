...
$sql = "SELECT product.productName, product.price, product.image, product.quantity, location.Zone, product.locationID FROM product join location on product.locationID = location.locationID WHERE gender = 'Men'and category ='Clothes'";
?>
...
<body>
    ...
    <div class="centerpage">
        <div>
            <div>
                <h1 style="text-align: center; margin-top: 80px;"><a href="main.php">Home</a>/<a href="Men.php">Men-Sportswear</a>/Clothes</h1>
            </div>
            <div>    
            <?php 
