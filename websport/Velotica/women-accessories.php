...
$sql = "SELECT product.productName, product.price, product.image, product.quantity, location.Zone, product.locationID FROM product join location on product.locationID = location.locationID WHERE gender = 'Women'and category ='Accessories'";
?>
...
<body>
    ...
    <div class="centerpage">
        <div>
            <div>
                <h1 style="text-align: center; margin-top: 80px;"><a href="main.php">Home</a>/<a href="women.php">Women-Sportswear</a>/Accessories</h1>
            </div>
            <div>    
            <?php 
                ...
                if($result-> num_rows > 0){
                    ...
                    while($row = $result -> fetch_assoc()){
                        ...
                        echo '<p>฿'.$row['price']. '</[p>';
                        echo '<a href="store_map.php" style ="text-decoration: none; color: black;"><p style="color: black;">Zone'.' '.$row['Zone']. '<img src="external-link.png" style="height:16px;width:16px;margin-left: 5px;"></p><a>';
                    ...
                    if($result-> num_rows < 5){
                        echo '<div class="placeholder-product"></div>';
                      }
                } 
                else {
